...
class StartPage(Base):
    ...
    first_slider_slide7 = '//span[@aria-label="Go to slide 7"]'                                     # локатор 5 слайда в первом слайдере
    ...
    def get_first_slider_slide7(self):
        return WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable((By.XPATH, self.first_slider_slide7)))
    ...
    def open_grill(self):
        self.get_first_slider_slide7().click()
        time.sleep(2)
