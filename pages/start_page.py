...
class StartPage(Base):
    ...
    first_slider_slide5 = '//span[@aria-label="Go to slide 5"]'                                     # локатор 5 слайда в первом слайдере
    ...
    def get_first_slider_slide5(self):
        return WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable((By.XPATH, self.first_slider_slide5)))
    ...
    def open_grill(self):
        self.get_first_slider_slide5().click()
        time.sleep(2)
        print("В первом слайдере выбираем 5 слайд")
    ...
    def select_product_from_slider(self):
        ...
        self.open_grill()                   # открываем страницу гриля из 5 слайда в первом слайдере
